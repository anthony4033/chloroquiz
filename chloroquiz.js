...
async function _pnetRun(){
  ...
  try{
    ...
    html += '<div id="pnet-compare-bar" style="display:none;margin-bottom:10px;padding:10px 12px;background:rgba(74,184,112,.08);border:1px solid rgba(74,184,112,.25);border-radius:10px">'
      ...
      + '<div style="display:flex;gap:8px;flex-wrap:wrap">'
      +   '<button onclick="_pnetOpenGemini()" style="padding:7px 13px;background:linear-gradient(135deg,rgba(66,133,244,.2),rgba(52,168,83,.15));border:1px solid rgba(66,133,244,.4);border-radius:9px;color:#7ab8f5;font-size:12px;font-weight:700;cursor:pointer">🤖 Comparer avec Gemini</button>'
...
function _pnetSearch1(idx){
  ...
  var aiUrl = 'https://gemini.google.com/app?q=' + encodeURIComponent('Décris ' + latin + ' : port, feuillage, rusticité, exposition, sol, usages en aménagement paysager');
  menu.innerHTML = ''
    ...
    + '<button onclick="window.open(\'' + aiUrl + '\',\'_blank\');document.getElementById(\'pnet-search-menu\').remove()" style="width:100%;padding:8px 10px;background:rgba(66,133,244,.1);border:none;border-radius:8px;color:#7ab8f5;font-size:13px;cursor:pointer;text-align:left">🤖 Gemini (IA)</button>';

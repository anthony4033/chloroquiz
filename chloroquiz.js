...
function buildPlantFromForm(){
  ...
  return {
    ...
    photo:(()=>{
      // Priorité : photo uploadée (b64) sinon URL
      if(formPhotoB64) return formPhotoB64;
      const el=document.getElementById('f-photo-url');
      return el?el.value.trim():'';
    })(),
    photo2:formPhoto2B64||(document.getElementById('f-photo-url2')?document.getElementById('f-photo-url2').value.trim():''),
    photo3:formPhoto3B64||(document.getElementById('f-photo-url3')?document.getElementById('f-photo-url3').value.trim():''),
    photo4:formPhoto4B64||(document.getElementById('f-photo-url4')?document.getElementById('f-photo-url4').value.trim():''),
  };
}

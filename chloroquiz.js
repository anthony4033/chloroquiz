...
function renderStats(){
  ...
  c.innerHTML=`
    ...
    <div class="pg-sub">Suivi de progression — ${apprentis.length} apprenti(s) · Moyenne classe : <strong style="color:var(--am2)">${classMoyenne}%</strong> · ${totalTermines} partie(s) terminée(s) · ${totalInterrompus} interrompue(s)</div>
    ${collectiveHTML}

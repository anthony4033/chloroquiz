...
async function renderMyPlants(){
  ...
  const pending = await countPendingShares(shareCode);
  ...
  c.innerHTML=`
    ...
    ${pending>0?`<div onclick="openPendingShares()" style="margin:0 0 14px;padding:12px 16px;background:rgba(232,160,32,.1);border:1px solid rgba(232,160,32,.3);border-radius:12px;cursor:pointer;display:flex;align-items:center;gap:10px">
      <span style="font-size:20px">📬</span>
      <div style="flex:1"><div style="font-weight:700;color:var(--am2)">${pending} fiche(s) reçue(s) en attente</div>

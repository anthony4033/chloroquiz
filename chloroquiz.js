    ...
    <tr id="csv-row-${i}" style="border-bottom:1px solid rgba(74,184,112,.08)">
      ...
      <td style="padding:6px 8px;text-align:center">
        ${r.status==='nouveau'
          ...
          : '<select id="csv-action-'+i+'" style="background:rgba(19,48,29,.8);border:1px solid rgba(232,160,32,.3);border-radius:8px;color:var(--am2);font-size:11px;padding:3px 8px;font-family:\'DM Sans\',sans-serif"><option value="skip">⏭ Ignorer</option><option value="update">✏️ Mettre à jour</option></select>'}
      </td>
    </tr>`).join('');
...
async function confirmCSVImport(rows){
  ...
  closeModal();
  if(!toProcess.length){ alert('Aucune plante à importer.'); return; }

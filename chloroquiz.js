...
function _pnetSearch1(idx){
  ...
  var aiUrl = 'https://www.perplexity.ai/search?q=' + encodeURIComponent('Décris ' + latin + ' : port, feuillage, rusticité, exposition, sol, usages en aménagement paysager');
  menu.innerHTML = ''
...
function _pnetOpenGemini(){
  ...
  var q;
  if(latins.length === 1){
    q = 'Décris ' + latins[0] + ' : port, feuillage, rusticité, exposition, sol, usages en aménagement paysager';
  } else {
    q = 'Compare ' + latins.join(' et ') + ' : différences de port, feuillage, rusticité, exposition, sol, usages en aménagement paysager. Aide-moi à choisir.';
  }

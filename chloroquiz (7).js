  ...
  for(var ti=0; ti<toProcess.length; ti++){
    ...
    if(action==='add'){
      ...
      if(idx>=0){
        ...
        plants[idx] = plant;       // écrasement complet : le CSV remplace tout
        updated++;
      }
    }
  }
...
function buildPlantFromForm(){
  ...
  return {
    ...
    photo2:formPhoto2B64||(document.getElementById('f-photo2-url')?document.getElementById('f-photo2-url').value.trim():''),
    photo3:formPhoto3B64||(document.getElementById('f-photo3-url')?document.getElementById('f-photo3-url').value.trim():''),
    photo4:formPhoto4B64||(document.getElementById('f-photo4-url')?document.getElementById('f-photo4-url').value.trim():''),
  };
}

...
async function _pnetRun(){
  ...
  try{
    ...
    var html = '<div style="font-size:12px;color:rgba(200,223,204,.35);margin-bottom:10px">' + results.length + ' resultat(s)</div>';
    results.forEach(function(r2, i){
      ...
      html += '<div style="background:rgba(255,255,255,.04);border:1px solid rgba(74,184,112,.12);border-radius:12px;padding:12px 14px;margin-bottom:8px">'
        ...
        +   '</div>'
        +   '<button onclick="_pnetFill(' + i + ',this)"'
        +     ' style="padding:7px 12px;background:rgba(74,184,112,.15);border:1px solid rgba(74,184,112,.35);border-radius:9px;color:#4ab870;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;flex-shrink:0">'
        +     '✅ Utiliser'
        +   '</button>'
        + '</div>'
        + '</div>';
